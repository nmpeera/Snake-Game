...
namespace SnakeGame
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            new Settings(); // Linkinf the Settings Class to this Form

            gameTimer.Interval = 1000 / Settings.Speed; // Chaning the game time to settings speed
        ...
        {
            // this is the Timers update sccreen function.
            ...
            else
            {
                ...
                // below the actions will probe the keys being pressd by the player
                // and moves accordingly

                if(Input.KeyPress(Keys.Right) || Input.KeyPress(Keys.D) && Settings.direction != Directions.Left)
                {
                    Settings.direction = Directions.Right;
                }
                else if (Input.KeyPress(Keys.Left) || Input.KeyPress(Keys.A) && Settings.direction != Directions.Right)
                {
                    Settings.direction= Directions.Left;
                }
                else if(Input.KeyPress(Keys.Up) || Input.KeyPress(Keys.W) && Settings.direction != Directions.Down)
                {
                    Settings.direction = Directions.Up;
                }
                else if(Input.KeyPress(Keys.Down) || Input.KeyPress(Keys.S) && Settings.direction != Directions.Up)
                {
            ...
            pbCanvas.Invalidate(); // refresh the picture box and upate the graphics on it
        }
        ...
        private void updateGraphics(object sender, PaintEventArgs e)
        {
            ...
            Graphics canvas = e.Graphics; // create a new graphics class callede canvas
        ...
        private void movePlayer()
        {
            ...
            for (int i = Snake.Count - 1; i >= 0; i--)
            {
                ...
                if (i == 0)
                {
                    ...
                    // restricts the snake from leaving the canvas
                    ...
                    // this loop will check if the snake had an collision with other body
        ...
        private void eat()
        {
            ...
            Snake.Add(body); // add the part to the snake array
